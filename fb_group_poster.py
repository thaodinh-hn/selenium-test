...
def fill_post_editor(driver: Any, message: str, *, timeout: float) -> None:
    ...
    publish_button = find_first_matching_element(
        driver,
        PUBLISH_BUTTON_XPATHS,
...
def create_group_post(
    ...
    *,
    ...
    try:
        ...
        fill_post_editor(driver, message, timeout=timeout)
